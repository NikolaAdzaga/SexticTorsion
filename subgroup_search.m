// This file is no longer necessary: it used so search for index-6 cases.
// The search is now done in index_3_or_6_subgroup_search.m.
// But as this file previously had a minor error:
// we used to compute the index in H, rather than Hsub (H' in the file),
        ...
        if H eq sub<H | Generators(Hsub) join {negI}> then
            ...
            for v in VectorsOrder9 do                    
                    ...
                    if Index(Hsub, Stab_v) eq 6 then
                        ...
                        printf "    Hsub is generated by: %o\n", [MatFromElm(Eltseq(g)) : g in Generators(Hsub)];
